...
<div class="container-fluid">
    <div class="row"  style="height: 100%; max-height: 100%">
        <div class="col-md-6">
            <div class="col-md-12"><h1 class="mt-3">The rules</h1></div>
            <hr>
            <div class="col-md-12"><h3 class="mt-3">Spot and map lots <i class="fas fa-search"></i></h3>Spot and map as many vacant lots as you can by clicking through satellite images. The star <img src="images/star.png" alt="star" style="max-width:3%; max-height:3%;"> indicates where someone surveyed vacant land. It might be possible that there is more vacant land elsewhere in the image. By <span style="background-color: #a9dabb"><a href="scoreoverview.php">clicking through the images</a></span>, you also earn tokens, your game currency.</div>
            <div class="col-md-12"><h3 class="mt-3">Acquire lots <i class="fa fa-shopping-cart" aria-hidden="true"></i></h3>If you come across a lot someone else has mapped while clicking through the images you can acquire it. The price of a lot is dynamic: It depends on how much you are willing to pay, your token count and the amount paid in a previous bid.</div>
            <div class="col-md-12"><h3 class="mt-3">Build! <i class="fas fa-building"></i></h3>Your lot will not be entirely secured from acquirement unless you decide to build something. You can choose different options <span style="background-color: #a9dabb"><a href="scoreoverview.php">here</a></span> based on your lot size and tokens available. Once the lot is occupied, no one will be able to take it from you.</div>
            <div class="col-md-12"><h3 class="mt-3">Flag <i class="fas fa-flag"></i></h3>You think someone mapped a lot that is not vacant? Click on the lot to flag it. If 3 more people agree with you, the lot will be deleted from the database. You are only allowed to flag one property per session.</div>
        </div>
        <div class="col-md-6">
            <div class="row">
              <div class="col-md-12"><h1 class="mt-3">Vacant or not?</h1></div>
              <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/ex1.jpg" alt="First slide" style="overflow: hidden">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/ex1.jpg" alt="Second slide" style="overflow: hidden">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/ex1.jpg" alt="Third slide" style="overflow: hidden">
    </div>
  </div>
